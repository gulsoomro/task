package com.infosecurity.task.config;
...
public class KakfaConfiguration {
    ...
    @Bean
    public KafkaTemplate<String, String> kafkaTemplatest() {
    ...
    // start
    @Bean
    public ConsumerFactory<String, Log> userConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Log> userKafkaListenerFactory() {
